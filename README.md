This repo exists only to forward `http://subugoe.github.io/hybrid_oa_dashboard/` (old) to `http://subugoe.github.io/hoad/` (new) as per [#55](https://github.com/subugoe/hoad/issues/55).
